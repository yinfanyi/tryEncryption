...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_config.setGeometry(QRect(140, 10, 171, 31))
        ...
        self.groupBox.setGeometry(QRect(23, 5, 71, 41))
        self.radioButton_decrpyt = QRadioButton(self.groupBox)
        self.radioButton_decrpyt.setObjectName(u"radioButton_decrpyt")
        self.radioButton_decrpyt.setGeometry(QRect(20, 20, 51, 20))
        self.radioButton_encrypt = QRadioButton(self.groupBox)
        self.radioButton_encrypt.setObjectName(u"radioButton_encrypt")
        self.radioButton_encrypt.setGeometry(QRect(20, 0, 51, 20))
        self.radioButton_encrypt.setChecked(True)
        MainWindow.setCentralWidget(self.centralwidget)
        self.groupBox.raise_()
        self.pushButton_config.raise_()
        self.plainTextEdit_output.raise_()
        self.plainTextEdit_input.raise_()
        self.pushButton_CopyInput.raise_()
        self.pushButton_generate_keys.raise_()
        self.pushButton_clearInput.raise_()
        self.line.raise_()
        self.pushButton_clearOutput.raise_()
        self.pushButton_CopyOutput.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_config.setText(QCoreApplication.translate("MainWindow", u"\u914d\u7f6e", None))
